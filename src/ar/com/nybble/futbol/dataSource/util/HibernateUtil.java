...
public class HibernateUtil {
    ...
    /*
     * Bloque est�tico de inicializaci�n.
     */
    static {
        
        /*
         * Inicializaci�n de la sesi�n por defecto.
         */
        try {
        ...
        /*
         * Inicializaci�n de la sesi�n de TEST.
         */
        try {
            ...
            // Si no existe el archivo de configuraci�n de test, no se
            // conseidera un error. Para cada try/catch s�lo deber� lanzarse
    ...
    /*
     * M�todo de utilidad que devuelve el map asociado al thread actual o uno
